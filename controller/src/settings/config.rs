...
pub struct AppSettings {
    ...
    #[serde(default = "bool_true")]
    pub aimbot_team_check: bool,    #[serde(default = "default_f32::<120, 1>")]
    pub aimbot_fov: f32,    #[serde(default = "default_f32::<15, 10>")]
    pub aimbot_smoothing: f32,

    #[serde(default = "default_u32::<1>")]
    pub aimbot_target_bone: u32, // 0 = head, 1 = chest (par défaut), 2 = closest

    #[serde(default = "bool_true")]
    pub aimbot_auto_shoot: bool,

    #[serde(default = "default_f32::<500, 1>")]
    pub aimbot_max_distance: f32,    #[serde(default = "bool_false")]
    pub aimbot_visible_only: bool,
    
    // Enhanced Aimbot settings
    #[serde(default = "default_aimbot_mode")]
    pub aimbot_enhanced_mode: KeyToggleMode,
    
    #[serde(default)]
    pub key_aimbot_enhanced: Option<HotKey>,
    
    #[serde(default = "bool_true")]
    pub aimbot_enhanced_team_check: bool,
    
    #[serde(default = "default_f32::<90, 1>")]
    pub aimbot_enhanced_fov: f32,
    
    #[serde(default = "default_f32::<10, 10>")]
    pub aimbot_enhanced_smoothing: f32,
    
    #[serde(default = "default_f32::<5, 10>")]
    pub aimbot_enhanced_randomize_factor: f32,
    
    #[serde(default = "default_u32::<0>")]
    pub aimbot_enhanced_target_bone: u32, // 0 = head, 1 = chest, 2 = pelvis
    
    #[serde(default = "bool_true")]
    pub aimbot_enhanced_auto_shoot: bool,
    
    #[serde(default = "default_f32::<500, 1>")]
    pub aimbot_enhanced_max_distance: f32,
    
    #[serde(default = "bool_true")]
    pub aimbot_enhanced_visible_only: bool,
    
    #[serde(default = "bool_true")]
    pub aimbot_enhanced_target_lock: bool,
    
    #[serde(default = "default_u32::<500>")]
    pub aimbot_enhanced_lock_duration: u32,
    
    #[serde(default = "bool_false")]
    pub aimbot_enhanced_draw_fov: bool,
